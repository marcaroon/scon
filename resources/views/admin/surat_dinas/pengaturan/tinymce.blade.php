                ...
                <div class="tab-pane active" id="form-utama">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control input-sm required judul isi-judul" name="judul" value="{{ $suratDinas->form_isian->individu->judul ?: 'Utama' }}" minlength="3" maxlength="100">
                            </div>
                        </div>
