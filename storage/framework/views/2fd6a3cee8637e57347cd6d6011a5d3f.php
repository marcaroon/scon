    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <div class="btn-group-vertical">
                ...
                <ul class="dropdown-menu" role="menu">
                    <?php if(!config_item('demo_mode') && ci_auth()->id_grup == $akses && !data_lengkap()): ?>
                        <li>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\scon\resources\views/admin/penduduk/index.blade.php ENDPATH**/ ?>