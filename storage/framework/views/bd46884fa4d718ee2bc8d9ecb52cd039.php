...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <?php if(can('u')): ?>
                <a class="btn btn-social btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" <?php echo cek_koneksi_internet() == false || $idm->error_msg === 'Periksa koneksi internet Anda.' ? 'disabled title="Perangkat tidak terhubung dengan jaringan"' : 'href="' . ci_route('status_desa.perbarui_idm', $tahun) . '"'; ?>><i class="fa fa-refresh"></i>Perbarui</a>
...
<?php echo $__env->make('admin.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\scon\resources\views/admin/status_desa/idm.blade.php ENDPATH**/ ?>